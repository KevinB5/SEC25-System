...
import pt.tecnico.sec.JSONGood;
import pt.tecnico.sec.Message;
import pt.tecnico.sec.PKI;
...
public enum GoodState {
	...
	public UserByzantine(String id, String ip) throws Exception {
		...
		if(allUsers.contains(idUser)) {
			...
			servs= h.keySet(); 
			lib = new LibraryByzantine(this, ip,h);
